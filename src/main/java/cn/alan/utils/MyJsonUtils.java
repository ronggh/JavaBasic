...
public class MyJsonUtils {
     ...
     */
    public static <T> T parseObject(JSONObject jsonObj, Class<T> clazz) throws JSONException {
        if (clazz == null || isNull(jsonObj)) {
            return null;
        }
        ...
        if (isMap(clazz)) {
            ...
            for (Field f : fields) {
                ...
                try {
                    ...
                    setField(obj, fieldMethod, f, jsonObj);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
